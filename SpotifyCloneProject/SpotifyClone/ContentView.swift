  ...
  var body: some View {
      ZStack {
        ...
        VStack {
          ...
          CurrentPlayingInfoBar(songName: "Sweetener", artistName: "Ariana Grande", isLike: true)
          SpotifySlider()
          PlayerControllerBar()
          BottomBar()
      }.padding(25)
...
struct GradientBackGround: View {
  ...
  var body: some View {
    LinearGradient(gradient: Gradient(colors: [color.opacity(0.8), color.opacity(0.0)]), startPoint: .top, endPoint: .bottom).ignoresSafeArea()
  }
}
